...
"""
#Getting image and it's width and height 
            ...
            features=datasets.Features(
                {
                    ...
                    "ner_tags": datasets.Sequence(
                        datasets.features.ClassLabel(
                            names = ["Title", "Heading", "Subheading", "Image", "NonText_footer", "NonText_Header", "Text", "Page_Heading", "Page_Footer"] #Enter the list of labels that you have here.
                            )
                    ),
